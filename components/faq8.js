          ...
          <div className="faq8-container10 thq-flex-column">
            <div className="thq-flex-column">
              <h2>
                {props.heading1 ?? (
                  <Fragment>
                    <h2 className="faq8-text19 thq-heading-2">FAQs</h2>
                  </Fragment>
                )}
              </h2>
            </div>
            <div className="thq-flex-column">
              <p>
                {props.content1 ?? (
                  <Fragment>
                    <p className="faq8-text20 thq-body-large">
                ...
                <div className="faq8-faq1">
                  ...
                  >
                    <p>
                      {props.faq1Question4 ?? (
                        <Fragment>
                          <p className="faq8-text18 thq-body-large">
                ...
                <div className="faq8-faq2">
                  ...
                  >
                    <p>
                      {props.faq2Question1 ?? (
                        <Fragment>
                          <p className="faq8-text17 thq-body-large">
                            Frequently Asked Questions
                          </p>
                        </Fragment>
                      )}
                ...
                <div className="faq8-faq3">
                  ...
                  >
                    <p>
                      {props.faq3Question ?? (
                        <Fragment>
                          <p className="faq8-text15 thq-body-large">
                            Frequently Asked Questions
                          </p>
                        </Fragment>
                      )}
              ...
              <button className="faq8-button thq-button-outline">
                <span>
                  {props.action ?? (
                    <Fragment>
