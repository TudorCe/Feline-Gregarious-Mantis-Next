    ...
    <>
          ...
          <div className="blog-post-header7-title">
            <div className="blog-post-header7-content1">
              <span>
                {props.category ?? (
                  <Fragment>
                    <span className="blog-post-header7-text7 thq-body-small">
                      Category
                    </span>
                  </Fragment>
                )}
            ...
            <div className="blog-post-header7-content2">
              <h1>
                {props.blogPostTitle ?? (
                  <Fragment>
                    <h1 className="blog-post-header7-text5 thq-heading-1">
                      Latest Blog Posts
                    </h1>
                  </Fragment>
                )}
              ...
              <span>
                {props.readTime ?? (
                  <Fragment>
                    <span className="blog-post-header7-text4 thq-body-small">
                      5 min read
                    </span>
                  </Fragment>
                )}
              </span>
              <div className="blog-post-header7-content3">
                <img
      ...
      <style jsx>
        {`
          ...
          .blog-post-header7-text4 {
            text-align: center;
          }
          .blog-post-header7-text5 {
            text-align: center;
          }
          .blog-post-header7-text7 {
            text-align: center;
          }
