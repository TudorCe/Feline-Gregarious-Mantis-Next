...
const BlogPostHeader11 = (props) => {
  return (
    <>
      <div className="blog-post-header11-content1 thq-section-padding">
        <div className="blog-post-header11-max-width thq-section-max-width">
          <div className="blog-post-header11-header">
            <div className="blog-post-header11-content2">
              <div className="blog-post-header11-breadcrumbs">
              ...
              <h1>
                {props.blogPostTitle ?? (
                  <Fragment>
                    <h1 className="thq-heading-1 blog-post-header11-text18">
            ...
            <div className="blog-post-header11-content3">
              <div className="blog-post-header11-avatar">
                <img
                  alt={props.avatarImageAlt}
                  src={props.avatarImageSrc}
                  className="blog-post-header11-author-image thq-img-round thq-img-ratio-1-1"
                />
                <div className="blog-post-header11-content4">
                  <span>
                    {props.avatarName ?? (
                      <Fragment>
                        <span className="blog-post-header11-text19 thq-body-small">
                          Full name
                        </span>
                      </Fragment>
                    )}
      ...
      <style jsx>
        {`
          ...
          .blog-post-header11-content3 {
            display: flex;
            align-self: stretch;
            align-items: center;
            justify-content: space-between;
          }
          .blog-post-header11-avatar {
            gap: var(--dl-space-space-unit);
            display: flex;
            align-items: center;
          }
          .blog-post-header11-author-image {
            width: var(--dl-size-size-small);
            height: var(--dl-size-size-small);
          }
          .blog-post-header11-content4 {
            display: flex;
            align-items: flex-start;
            flex-direction: column;
          }
