...
const BlogPostHeader1 = (props) => {
  return (
    <>
      <div className="blog-post-header1-content1 thq-section-padding">
          ...
          <div className="blog-post-header1-header">
            <div className="blog-post-header1-content2">
              ...
              <h1>
                {props.blogPostTitle ?? (
                  <Fragment>
                    <h1 className="blog-post-header1-text16 thq-heading-1">
            ...
            <div className="blog-post-header1-content3">
              <div className="blog-post-header1-avatar">
                ...
                />
                <div className="blog-post-header1-content4">
                  <span>
                    {props.avatarName ?? (
                      <Fragment>
                        <span className="blog-post-header1-text17 thq-body-small">
                          Full name
                        </span>
                      </Fragment>
                    )}
